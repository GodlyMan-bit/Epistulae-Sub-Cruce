...
> “If there were no eternal law, there would be no basis for any law. If a man argues that 'evil' exists, he inadvertently proves that 'good' exists. And if he admits that a standard of 'good' exists, he must admit there is a source for that standard. You cannot have a crooked line unless you first have the concept of a straight one. To deny the source of the Law is to deny the existence of the Light by which we see the shadows." —St. Thomas Aquinas
